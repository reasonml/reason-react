...
If you modify a word inside a `<translate>` tag, or rearrange `sidebars.json`, make sure you also run `yarn write-translations` too. Otherwise you might get a runtime error/stale headers.
