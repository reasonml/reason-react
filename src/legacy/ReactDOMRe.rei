...
[@deprecated
  "Please use:
  ReactDOM.querySelector(selector)
    ->Belt.Option.map(root => ReactDOM.render(..., root))"
]
let renderToElementWithClassName: (React.element, string) => unit;
...
let renderToElementWithId: (React.element, string) => unit;
...
module Experimental: {
  ...
  [@deprecated
    "Please use:
    ReactDOM.querySelector(selector)
      ->Belt.Option.map(ReactDOM.createRoot)"
  ]
  let createRootWithClassName: string => option(root);
...
[@deprecated
  "Please use:
  ReactDOM.querySelector(selector)
    ->Belt.Option.map(root => ReactDOM.hydrate(..., root))"
]
let hydrateToElementWithClassName: (React.element, string) => unit;
...
let hydrateToElementWithId: (React.element, string) => unit;
