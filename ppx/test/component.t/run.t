  ...
  module Using_React_memo =
    struct
      ...
      let make =
        React.memo
          (let Output$Using_React_memo (Props : < a: 'a   >  Js.t) =
             make ~a:(Props ## a) in
           Output$Using_React_memo)
    end
  module Using_memo_custom_compare_Props =
    struct
      ...
      let make =
        let Output$Using_memo_custom_compare_Props (Props : < a: 'a   >  Js.t)
          = make ~a:(Props ## a) in
        Output$Using_memo_custom_compare_Props
    end
  module Forward_Ref =
    struct
      external makeProps :
