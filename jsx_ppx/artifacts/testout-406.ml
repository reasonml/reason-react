...
[@@bs.obj ]
let make =
  let Test-406 (Props : < a: 'a  ;b: 'b   >  Js.t) =
    let a = Props ## a in
    let b = Props ## b in
...
module Bar =
  struct
    ...
    [@@bs.obj ]
    let make =
      let Test-406$Bar (Props : < a: 'a  ;b: 'b   >  Js.t) =
        let a = Props ## a in
        let b = Props ## b in
    ...
    [@@bs.obj ]
    let component =
      let Test-406$Bar$component (Props : < a: 'a  ;b: 'b   >  Js.t) =
        let a = Props ## a in
        let b = Props ## b in
        Js.log "This function should be named `Test$Bar$component`";
        ReactDOMRe.createDOMElementVariadic "div" [||] in
      Test-406$Bar$component
  end
...
module Func(M:X_int) =
  struct
    ...
    let make =
      React.forwardRef
        (let Test-406$Func (Props : < a: 'a  ;b: 'b   >  Js.t) ref =
           let a = Props ## a in
           let b = Props ## b in
...
external makeProps :
  ?a:'a ->
    ...
    ""[@@bs.obj ]
let make =
  let Test-406 (Props : < a: 'a option  ;b: 'b option   >  Js.t) =
  ...
  struct
    ...
    module Two =
      struct
        ...
        [@@bs.obj ]
        let make =
          let Test-406$Issue369Optionals$Two
            (Props : < prop: string option   >  Js.t) =
            let (prop : string option) =
              match Props ## prop with | Some prop -> prop | None -> "" in
            React.null in
          Test-406$Issue369Optionals$Two
      end
    module All =
      struct
        external makeProps :
                          ...
                          ?key:string ->
                            unit ->
                              <
                                ...
                                optional: 'optional option  ;optionalT: 
                                                               string option  ;
                                default: 'default option  ;defaultT: 
                                                             string option  ;
                                ...
                                >  Js.t = ""[@@bs.obj ]
        let make =
          let Test-406$Issue369Optionals$All
            (Props :
              <
                labelled: 'labelled  ;labelledT: string  ;optional: 'optional
                                                                    option  ;
                optionalT: string option  ;default: 'default option  ;
                defaultT: string option  ;nonOptionalOptionT: string option  ;
                nonOptionalDefaultT: string option   >  Js.t)
            =
            ...
            let (nonOptionalDefaultT : string option) =
              ...
              | None -> None in
            React.null in
          Test-406$Issue369Optionals$All
      end
    ...
    module One =
      struct
        ...
        let rec make =
          ...
          Test-406$Recursive$One
        and component =
          let Test-406$Recursive$One$component
            (Props : < prop1: 'prop1  ;prop2: 'prop2   >  Js.t) =
            let prop1 = Props ## prop1 in
            let prop2 = Props ## prop2 in
            ReactDOMRe.createDOMElementVariadic "div"
          ...
          Test-406$Recursive$One$component
      end
    let one =
      ...
      struct
        external makeProps :
          tuple:'tuple -> ?key:string -> unit -> < tuple: 'tuple   >  Js.t =
            ""[@@bs.obj ]
        let make =
          let Test-406$Issue378Destructuring$One
            (Props : < tuple: 'tuple   >  Js.t) =
            let (a, b) = Props ## tuple in React.null in
          Test-406$Issue378Destructuring$One
      end
    ...
    module One =
      struct
        ...
        let make =
          let foo = 1 in
          Js.log foo;
          (let Test-406$Blocks$One (Props : < prop: 'prop   >  Js.t) =
