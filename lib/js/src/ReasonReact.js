...
function createClass(debugName) {
  return ReasonReactOptimizedCreateClass.createClass({
              ...
              getInitialState: (function () {
                  ...
                  var initialReasonState = Curry._1(component[/* initialState */11], /* () */0);
                  if (component[/* didCatch */8] !== anyToUnit3) {
                    $$this.componentDidCatch = (function (error, info) {
                        ...
                        return Curry._3(component[/* didCatch */8], self, error, /* record */[/* componentStack */info.componentStack]);
                      });
                  }
                  return {
              ...
              componentDidMount: (function () {
                  ...
                  var curReasonState = curTotalState.reasonState;
                  var self = $$this.self(curReasonState, component[/* retainedProps */12]);
                  if (component[/* subscriptions */14] !== subscriptionsDefault) {
                    var subscriptions = arrayOfList(Curry._1(component[/* subscriptions */14], self)).map((function (param) {
              ...
              componentDidUpdate: (function (prevProps, prevState) {
                  ...
                  if (newComponent[/* didUpdate */5] !== anyToUnit) {
                    ...
                    var oldSelf_002 = /* retainedProps */oldConvertedReasonProps[0][/* retainedProps */12];
              ...
              componentWillUnmount: (function () {
                  ...
                  if (component[/* willUnmount */6] !== anyToUnit) {
                    Curry._1(component[/* willUnmount */6], $$this.self(curReasonState, component[/* retainedProps */12]));
                  }
              ...
              componentWillReceiveProps: (function (nextProps) {
                  ...
                  if (newComponent[/* willReceiveProps */3] !== willReceivePropsDefault) {
                    ...
                    return thisJs.setState((function (curTotalState, _) {
                                  var curReasonState = curTotalState.reasonState;
                                  var oldSelf = $$this.self(curReasonState, oldComponent[/* retainedProps */12]);
              ...
              shouldComponentUpdate: (function (nextJsProps, nextState, _) {
                  ...
                  var nextReasonState = nextState.reasonState;
                  var newSelf = $$this.self(nextReasonState, newComponent[/* retainedProps */12]);
                  if (newComponent[/* shouldUpdate */9] !== anyToTrue) {
                    var curState = thisJs.state;
                    var curReasonState = curState.reasonState;
                    var oldSelf_000 = /* handle */newSelf[/* handle */0];
                    var oldSelf_002 = /* retainedProps */oldConvertedReasonProps[0][/* retainedProps */12];
                    ...
                    return Curry._1(newComponent[/* shouldUpdate */9], /* record */[
                                /* oldSelf */oldSelf,
                                /* newSelf */newSelf
                              ]);
                  } else {
              ...
              sendMethod: (function (action) {
                  ...
                  var convertedReasonProps = convertPropsIfTheyreFromJs(thisJs.props, thisJs.jsPropsToReason, debugName);
                  var component = convertedReasonProps[0];
                  if (component[/* reducer */13] !== reducerDefault) {
                    var sideEffects = [(function () {
                          return /* () */0;
                        })];
                    var partialStateApplication = Curry._1(component[/* reducer */13], action);
                    return thisJs.setState((function (curTotalState, _) {
                                  var curReasonState = curTotalState.reasonState;
              ...
              render: (function () {
                  ...
                  var curState = thisJs.state;
                  var curReasonState = curState.reasonState;
                  return Curry._1(created[/* render */10], $$this.self(curReasonState, created[/* retainedProps */12]));
                })
            });
}
...
function element($staropt$star, $staropt$star$1, component) {
  ...
  var match = component[/* jsElementWrapped */15];
  if (match) {
...
function wrapJsForReason(reactClass, props, children) {
  ...
  return /* record */[
          ...
          /* didCatch */dummyInteropComponent[/* didCatch */8],
          /* shouldUpdate */dummyInteropComponent[/* shouldUpdate */9],
          /* render */dummyInteropComponent[/* render */10],
          /* initialState */dummyInteropComponent[/* initialState */11],
          /* retainedProps */dummyInteropComponent[/* retainedProps */12],
          /* reducer */dummyInteropComponent[/* reducer */13],
          /* subscriptions */dummyInteropComponent[/* subscriptions */14],
